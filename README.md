...
一个开箱即用的**按城市计算工资**的 Agent Skill：社保、公积金、个人所得税、年终奖、历史明细与趋势图，打开先选城市，按当地政策实时计算。**已内置广东 21 市 + 四川 21 市州 + 北京 / 上海**（44 城），可扩展全国地市。
...
│   ├── test-calc.js         #   953 项断言：税率表/年终奖陷阱/端到端算例/D1D2 回归
